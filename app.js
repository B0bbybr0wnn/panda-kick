...
function avatarSVG(id) {
  const stroke = "#00FFB2";
  const s = `stroke="${stroke}" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"`;
  const icons = {
    default: `<svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" ${s}/></svg>`,
    ...
    crown: `<svg viewBox="0 0 100 100"><path d="M25 75 L25 45 L40 60 L50 35 L60 60 L75 45 L75 75 Z M25 75 L75 75" ${s}/></svg>`,
    bolt: `<svg viewBox="0 0 100 100"><path d="M55 15 L30 55 L48 55 L45 85 L70 45 L52 45 Z" ${s}/></svg>`,
    panda: `<svg viewBox="0 0 100 100"><circle cx="50" cy="55" r="30" ${s}/><circle cx="30" cy="30" r="10" ${s}/><circle cx="70" cy="30" r="10" ${s}/><circle cx="42" cy="50" r="5" fill="${stroke}"/><circle cx="58" cy="50" r="5" fill="${stroke}"/></svg>`,
    whistle: `<svg viewBox="0 0 100 100"><circle cx="35" cy="60" r="18" ${s}/><path d="M50 55 L85 45 Q90 45 90 52 L90 60 L50 68" ${s}/></svg>`,
    stadium: `<svg viewBox="0 0 100 100"><ellipse cx="50" cy="55" rx="40" ry="18" ${s}/><path d="M10 55 L10 45 M90 55 L90 45 M20 50 L20 40 M80 50 L80 40" ${s}/></svg>`,
